...
async def export_opportunities_csv(
    ...
    writer.writerow([
        ...
        "Georgian Median (₾)", "Georgian Median ($)", "Net Revenue ($)", "Selling Fees ($)", "# Georgian Listings",
    ...
    for opp, item in rows:
        ...
        writer.writerow([
            ...
            f"{opp.georgian_median_price_gel:.2f}" if opp.georgian_median_price_gel is not None else "",
            f"{opp.georgian_median_price_usd:.2f}" if opp.georgian_median_price_usd is not None else "",
            ...
            f"{opp.profit_gel:.2f}" if opp.profit_gel is not None else "",
            f"{opp.profit_margin_pct:.1f}" if opp.profit_margin_pct is not None else "",
